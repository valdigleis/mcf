...
\begin{definicao}[Consequência em sistemas axiomáticos]\label{def:ConsequênciaAxiomatica}
...
\begin{definicao}[Consequência Semântica]\label{def:ConsequênciaSemantica}
